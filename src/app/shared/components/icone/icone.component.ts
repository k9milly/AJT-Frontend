...
// ---------------------------------------------------------------
// icones do painel (desenhos do lucide, os mesmos do autonomousapi)
// ---------------------------------------------------------------
// copiados como svg em vez de instalar uma biblioteca de icones: sao poucos,
// nao pesam no bundle e nao dependem de rede/cdn.
// pra adicionar um icone novo: pegar o conteudo interno do svg em lucide.dev e colar aqui.
const ICONES = {
  ...
  'pino': '<path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"/><circle cx="12" cy="10" r="3"/>',
  ...
  'cracha': '<path d="M16 10h2"/><path d="M16 14h2"/><path d="M6.17 15a3 3 0 0 1 5.66 0"/><circle cx="9" cy="11" r="2"/><rect x="2" y="5" width="20" height="14" rx="2"/>',
  ...
  'atualizar': '<path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/>',
} as const;

export type NomeIcone = keyof typeof ICONES;

// uso: <app-icone nome="rota" class="size-4" />
// o tamanho e a cor vem das classes de quem usa (o svg herda currentColor)
@Component({
  selector: 'app-icone',
  standalone: true,
...
export class IconeComponent {
  ...
  // o conteudo vem da tabela fixa acima (nunca de dado do usuario), por isso e seguro liberar
  conteudo = computed<SafeHtml>(() => this.sanitizer.bypassSecurityTrustHtml(ICONES[this.nome()]));
}
